  ...
  template: `
    <div class="min-h-full flex flex-col">
      ...
      <div class="flex flex-1 pt-[64px] overflow-hidden">
        <main class="w-full px-6 py-2 overflow-y-auto">
...
<svg [routerLink]="['/dashboard']" class="w-[20px] h-[20px] text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" viewBox="0 0 24 24">
...
<div class="min-h-full flex flex-col">
      ...
      <div class="flex flex-1 pt-[64px] overflow-hidden">
        ...
        <div class="flex h-screen w-16 flex-col justify-between border-e bg-dark-900">
      <div>
